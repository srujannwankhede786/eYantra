...
class edrone_msgs {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('droneIndex')) {
        this.droneIndex = initObj.droneIndex
      }
      else {
        this.droneIndex = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [droneIndex]
    bufferOffset = _serializer.int64(obj.droneIndex, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [droneIndex]
    data.droneIndex = _deserializer.int64(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new edrone_msgs(null);
    ...
    if (msg.droneIndex !== undefined) {
      resolved.droneIndex = msg.droneIndex;
    }
    else {
      resolved.droneIndex = 0
    }
