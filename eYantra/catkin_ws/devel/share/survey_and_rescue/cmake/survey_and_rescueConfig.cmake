...
if("TRUE" STREQUAL "TRUE")
  set(survey_and_rescue_SOURCE_PREFIX /home/itachi/catkin_ws/src/survey_and_rescue)
  set(survey_and_rescue_DEVEL_PREFIX /home/itachi/catkin_ws/devel)
  ...
  set(survey_and_rescue_INSTALL_PREFIX /home/itachi/catkin_ws/install)
...
if(NOT "/home/itachi/catkin_ws/devel/include " STREQUAL " ")
  set(survey_and_rescue_INCLUDE_DIRS "")
  set(_include_dirs "/home/itachi/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'survey_and_rescue' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/itachi/catkin_ws/src/survey_and_rescue/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT survey_and_rescue_NUM_DUMMY_TARGETS)
      set(survey_and_rescue_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::survey_and_rescue::wrapped-linker-option${survey_and_rescue_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR survey_and_rescue_NUM_DUMMY_TARGETS "${survey_and_rescue_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::survey_and_rescue::wrapped-linker-option${survey_and_rescue_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND survey_and_rescue_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/itachi/catkin_ws/devel/lib;/home/itachi/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(survey_and_rescue_EXPORTED_TARGETS "survey_and_rescue_generate_messages_cpp;survey_and_rescue_generate_messages_eus;survey_and_rescue_generate_messages_lisp;survey_and_rescue_generate_messages_nodejs;survey_and_rescue_generate_messages_py")
...
set(pkg_cfg_extras "survey_and_rescue-msg-extras.cmake")
